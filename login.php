...
<body>
    ...
    <main class="main">
        <div class="container">
            <form class="lg-form" method="post" action="login.php">
                <h2 class="lg-form-tl">Авторизація</h2>
                <div class="lg-form-msg">
                    <?php include "assets/php/database/errorInfo.php"; ?>
                </div>
                <div class="lg-form-items">
                    <div class="lg-form-item">
                        <input name="login" type="text" id="formLogin" placeholder="Введіть ваш логін" class="lg-form-inp">
                    </div>
                    <div class="lg-form-item">
                        <input name="password" type="password" id="formPass" placeholder="Введіть ваш пароль" class="lg-form-inp">
                    </div>
                    <div class="lg-form-item">
                        <button type="submit" class="lg-form-btn" name="button-lg">Увійти</button>
                    </div>
                </div>
            </form>
        </div>
