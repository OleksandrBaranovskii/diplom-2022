<?php 
    ...
    $sth = $pdo->prepare("SELECT * FROM `poslygi_ps1` ");
    $sth->execute();
...
<body>
    ...
    <main class="main">
        <div class="container">
            <div class="poslyga">
                <div class="poslyga-title">Пошиття одягу</div>
                            ...
                            <div class="li-pg-content">
                                <div class="li-pg-text-content">
                                    ...
                                    <h2 class="li-pg-content-desc">
                                        Пошиємо джинси швидко й якісно.
                                    </h2>
                                </div>
                    ...
                    <li class="li-poslyga-item">
                        <a href="#">
                            ...
                            <div class="li-pg-content">
                                <div class="li-pg-text-content">
                                    <h2 class="li-pg-content-title">
                                        Пошиття шкіряних виробів
                                    </h2>
                                    <h2 class="li-pg-content-desc">
                                        Пошиємо шкіряні виробів швидко й якісно.
                                    </h2>
                                </div>
                                <p class="li-pg-content-button">Докладніше →</p>
                            </div>
                        ...
                        <a href="#">
                            ...
                            <div class="li-pg-content">
                                <div class="li-pg-text-content">
                                    ...
                                    <h2 class="li-pg-content-desc">
                                        Пошиємо хутряні вироби швидко й якісно.
                                    </h2>
                                </div>
                                <p class="li-pg-content-button">Докладніше →</p>
                            </div>
                ...
                <div class="poslyga-title">Ціни на пошиття одягу</div>
