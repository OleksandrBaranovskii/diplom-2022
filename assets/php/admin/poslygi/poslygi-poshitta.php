<?php
    ...
    $sth = $pdo->prepare("SELECT * FROM `poslygi_ps1` ORDER BY `id` DESC");
    $sth->execute();
        ...
        <div class="container">
            <div class="layout layout-sidebar">
                <main class="cabinet-content">
                    <p class="cabinet-title">Керування таблицями пошиття</p>
                    <ul class="cards-list">
                        <details class="ls-card" open>
                            <summary class="card-header">
                                <p class="card-title">Ціни на пошиття одягу</p>
                                            ...
                                            <table class="poslyga-table">
                                                <thead class="poslyga-thead">
                                                    ...
                                                    <tr class="pg-tbody-down">
                                                        <form action="poslygi-poshitta.php" method="POST">
                                                            <td class="pg-td">
                                                            ...
                                                            <td class="pg-td">
                                                                <div class="td-elements">
                                                                    <button class="pg-td-btn" type="submit" name="add_ps">
                                                        ...
                                                        <tr class="pg-tbody-up">
                                                            ...
                                                            <td class="pg-td">
                                                                <div class="td-elements">
                                                                    ...
                                                                    <a href="poslygi-remont.php?delete_ps=<?=$poslyga['id'];?>">
                                                                        <svg class="icon-svg bt-el-icon svg-btn" aria-hidden="true" viewBox="0 0 18 18">               
