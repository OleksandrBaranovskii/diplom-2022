            ...
            <div class="layout layout-sidebar">
                <main class="cabinet-content">
                    ...
                    <div class="users-table">
                        ...
                        <div class="table-col-3">Логін</div>
                        <div class="table-col-2">Роль</div>
                        <div class="table-col-4">Керування</div>
                    </div>
                    <?php foreach ($users as $key => $user): ?>
                    <div class="users-post">
                        <div class="id table-col-1"><?=$user['id'];?></div>
                        <div class="login table-col-3"><?=$user['login'];?></div>
                        <?php if ($user['admin'] == 1): ?>
                            <div class="role table-col-2">Admin</div>
                            <?php else: ?>
                                <div class="role table-col-2">User</div>
                        <? endif ?>
                        <div class="edit table-col-2">
