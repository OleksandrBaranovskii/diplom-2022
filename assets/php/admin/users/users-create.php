        ...
        <div class="container">
            <div class="layout layout-sidebar">
                <main class="cabinet-content">
                    <form class="rg-form" method="post" action="users-create.php">
                        <h2 class="lg-form-tl">Створення користувача</h2>
                        ...
                        <div class="lg-form-items">
                            ...
                            <div class="lg-form-item">
                                <button type="submit" class="lg-form-btn" name="button-rg">Створити</button>
                            </div>
                        </div>
                    </form>
                </main>
